...
typedef int (*acdb_loader_reload_acdb_files_t) (char *, char *, char *, int);
...
static acdb_loader_reload_acdb_files_t f_acdb_loader_reload_acdb_files;
...
int acdb_loader_init_v2(const char *a, char *b, int c)
{
    ...
    if (acdb_handle == NULL) {
        ...
        f_acdb_loader_reload_acdb_files = (acdb_loader_reload_acdb_files_t)
                                                dlsym(acdb_handle, "acdb_loader_reload_acdb_files");
...
int acdb_loader_reload_acdb_files(char *a, char *b, char *c, int d)
{
    int ret = f_acdb_loader_reload_acdb_files(a, b, c, d);
    ALOGI("%s: %s %s %s %d => %d", __func__, a, b, c, d, ret);
    return ret;
}
