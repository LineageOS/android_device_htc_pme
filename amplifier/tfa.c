...
{
    tfa_set_bitfield(t, BF_DM_SAMPLE_SIZE, 23);
    tfa_set_bitfield(t, BF_TDM_NBCK, 2);
    tfa_set_bitfield(t, BF_TDM_SOURCE6_IO, 0);
    tfa_set_bitfield(t, BF_TDM_SOURCE5_IO, 0);
    tfa_set_bitfield(t, BF_TDM_SOURCE5_SLOT, 1);
    tfa_set_bitfield(t, BF_TDM_SOURCE7_SLOT, 1);
    tfa_set_bitfield(t, BF_TDM_SOURCE8_SLOT, 0);
}
#endif
...
int tfa_startup(tfa_t *t, tfa_cont_t *tc)
{
    ...
    factory_trimmer(t);
    tfa_power_on(t);
    tfa_set_register(t, bf_register(BF_SRC_SET_CONFIGURED), 1);

    wait_dsp_system_stable_is(t, 1);


#if 0
    tfa_set_bitfield(t, BF_ENBL_POWERSWITCH, 1);
    tfa_set_bitfield(t, BF_ENBL_PDM_SS, 0);

    tfa_set_bitfield(t, BF_ENBL_BOOST, 1);
    tfa_set_bitfield(t, BF_BOOST_VOLT, 6);
    tfa_set_bitfield(t, BF_ENBL_BOD, 1);
    tfa_set_bitfield(t, BF_EXT_TEMP, 25);
    tfa_set_bitfield(t, BF_EXT_TEMP_SEL, 1);
    tfa_set_bitfield(t, BF_ENBL_BOOST, 0);
#endif
...
static int speaker_startup(tfa_t *t, tfa_cont_t *tc, int force_startup, int profile_num)
{
    if (force_startup) {
        ...
        tfa_cont_write_profile_files(tc, profile_num, t);
    }
...
int tfa_start(tfa_t *t, tfa_cont_t *tc)
{
    int cal_profile = -1;
    ...
    speaker_boost(t, tc, 0, cal_profile);
...
int tfa_start_dsp(tfa_t *t, tfa_cont_t *tc)
{
    ...
    tfa_set_bitfield(t, BF_CF_RST_DSP, 0);
...
int tfa_set_swvstep(tfa_t *t, int swvstep)
{
    ...
    t->swvstep = swvstep;
    tfa_set_bitfield(t, BF_SW_PROFILE, swvstep+1);
